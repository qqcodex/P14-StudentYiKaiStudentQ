...
{
    // Save queue
    using (StreamWriter sw = new StreamWriter("C:\\Users\\yikai\\source\\repos\\PRG2_ASSG\\PRG2_ASSG\\queue.csv")) // replace file name with your file path - doesn't work when just "queue.csv" is written
    {
    ...
    // Save stack
    using (StreamWriter sw = new StreamWriter("C:\\Users\\yikai\\source\\repos\\PRG2_ASSG\\PRG2_ASSG\\stack.csv")) // replace file name with your file path - doesn't work when just "stack.csv" is written
    {
        sw.WriteLine("OrderId,CustomerEmail,RestaurantId,DeliveryDate,DeliveryTime,DeliveryAddress,CreatedDateTime,TotalAmount,Status,Items,PaymentMethod");
